...
public class SimpleListAdapter extends BaseAdapter implements ExpandableItem.ItemOpenListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view_right = tst_item.right_view;
        ...
        if (view_right == null) {
            view_right = inflater.inflate(R.layout.item_right, null);
            tst_item.right_view = view_right;
        }
        ...
        view.setup.right_layout = view_right;
        ...
        view.setup.is_expanded = tst_item.is_open; // this will reset view to either opened or closed after you scroll
